...
> Une entrée par session de validation. Les plus récentes en haut.
...
**Périmètre testé** :
- (quels chantiers / quels flux)

**État du repo au moment du test** :
- branche :
- dernier commit :
...
**Résultats** :
- ✅ ce qui marche
- ⚠️ ce qui marche avec réserve
- ❌ ce qui ne marche pas

**Décisions prises suite à cette validation** :
- ...
